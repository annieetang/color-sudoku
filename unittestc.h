/* 
 * unittestc.h - some useful MACROS for controlling unit tests for create.c
 *
 * Adapted from David Kotz, May 2016
 * for Annie Tang, Devon Starr, Amanda Sun, CS50 Final Project, Spring 2022
 *
 * This code, and the code that uses them, would likely be enclosed 
 * in
...
#ifndef __UNITTESTC_H
#define __UNITTESTC_H
